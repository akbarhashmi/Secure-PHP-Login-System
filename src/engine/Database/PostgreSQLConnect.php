 ...
 * @codeCoverageIgnore
 */
class PostgreSQLConnect extends PDO implements PostgreSQLConnectInterface
{
    ...
    /**
     * Try to connect to the pgsql server.
     *
    ...
    private function formulateDns(string $hostname, string $port, string $database)
    {
        ...
        return "pgsql:host={$hostname};port={$port};dbname={$database};charset=utf8";
    }
